    ...
    const features = [
        {
            ...
            className:
                "col-span-1 lg:col-span-4 border-b lg:border-r border-border dark:border-neutral-800",
        },
        {
            ...
            className: "border-b border-border col-span-1 lg:col-span-2 dark:border-neutral-800",
        },
        {
            ...
            className:
                "col-span-1 lg:col-span-3 lg:border-r border-border dark:border-neutral-800",
        },
        {
    ...
    return (
        <div className="relative z-20 mx-auto max-w-7xl py-10 lg:py-40">
            ...
            <div className="relative">
                <div
                    className="mt-12 grid grid-cols-1 rounded-md lg:grid-cols-6 xl:border border-border dark:border-neutral-800">
