...
export default function WorldMap({
  ...
  return (
    <div className={cn('relative w-full rounded-lg font-sans', className)}>
      <img
        src={`data:image/svg+xml;utf8,${encodeURIComponent(svgMap)}`}
        className="pointer-events-none h-full w-full select-none [mask-image:linear-gradient(to_bottom,transparent,white_7%,white_93%,transparent)]"
        alt="world map"
        height="495"
        width="1056"
        draggable={false}
